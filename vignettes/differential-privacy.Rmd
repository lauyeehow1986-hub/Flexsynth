...
exponential-mechanism rounds) separately from the measurement noise. Adaptive
selection is **flat-table only** for now — it is refused on a longitudinal or
linked release — and `treewidth` is supported for 1 and 2.
