...
Remaining limitation under DP: within-table longitudinal (Markov) structure is not
modelled for a linked table. Constraints are refused, as elsewhere under DP.

## What Track B does *not* do (yet)

- **Cross-table conditioning beyond the immediate parent**, and within-table
  longitudinal structure for a linked child, are not modelled;
