...
- **Cross-conditioning a longitudinal child's *transitions*** is not modelled: the
  parent conditions the initial state (and thus, through autocorrelation, the whole
  trajectory), but each within-unit step $P(v_t \mid v_{t-1})$ stays parent-free.
